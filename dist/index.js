...
function createExecCoordPrompt(plan, currentMap, options) {
...
function createExecEditorPrompt(filePath, changeDescription, currentContent, plan) {
...
function parseExecChangeSpecs(coordinatorOutput) {
    const specs = [];
    let currentPath = "";
    let currentDesc = "";
